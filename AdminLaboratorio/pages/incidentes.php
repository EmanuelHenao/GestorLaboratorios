      ...
      <div class="wrapper wrapper--w680">
        <div class="card card-1">
          <div class="card-body">
            ...
            <form action="../php/insertarComentario.php" method="post" onsubmit="return validarComentario();">
              <div class="row row-space">
                <div class="input-group">
                  <div class="rs-select2 js-select-simple select--no-search">
                    <select name="tipo" class="col-5" id="tipo" required>
                      <option disabled="disabled" selected="selected">Seleccione una opción</option>
                ...
                <div class="row row-space">
                  <div class="input-group">
                    <textarea name="texto" id="texto" rows="8" cols="68"></textarea>
                  </div>
                </div>
              </div>
              <div class="p-t-20">
