      ...
      <div class="page-wrapper p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
          <div class="card card-1">
            <div class="card-body">
              <form action="../php/insertarReserva.php" method="POST" onsubmit="return validarReserva();">
                <div class="input-group">
                  <input class="input--style-1" type="text" placeholder="Nombre" name="name" id="name" >
                </div>
                <div class="input-group">
                  <input class="input--style-1" type="number" value="<?php echo $codigo; ?>" name="codigo" id="codigo" >
                </div>
                <div class="input-group">
                  <input class="input--style-1" type="email" placeholder="Correo electronico" name="email" id="email" >
                </div>
                <div class="row row-space">
                  ...
                  <div class="form-group col-md-6">
                    <select name="programa" class="form-control" id="programa" required>
                      <option disabled="disabled" selected="selected">---Programa---</option>
                      <?php
