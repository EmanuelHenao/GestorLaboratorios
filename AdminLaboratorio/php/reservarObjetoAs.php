<?php
  ...
  $query = "SELECT MAX(indice) FROM asistencia";
  ...
  if($resultado->num_rows > 0){
    $salida.="<div style='margin:150px 150px 0 150px;'>
            ...
            while($row = $resultado->fetch_row()){
                $salida.= "<tr class='selected'>
                        <th scope='row'>".$i++."</th>
                        <td>".$row[0]."</td>
                        <td>
                          <a href='../php/insertarObjetoAsistencia.php?var=".$row[1]."&var2=".intval($numReserva['MAX(indice)'])."' onClick='bienHecho()'>
